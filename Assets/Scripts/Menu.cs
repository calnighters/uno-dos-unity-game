...
public class Menu : MonoBehaviour
{
    ...
    { //start function
        ...
        { //sets a random color and number for the cards
    ...
    { //starts the setup canvas screen
        setupCan.SetActive(openClose);
    }
    public void play()
    { //finds the toggle that is on to decide how many ai players there will be
        for (int i = 0; i < 5; i++)
        {
    ...
    void Update()
    { //this takes care of moving all of the cards in the scroll. It resets them back to the top as well
        for (int i = 0; i < 6; i++)
        {
